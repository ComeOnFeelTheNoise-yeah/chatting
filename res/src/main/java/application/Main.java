...
public class Main extends Application {
    ...
    public void init() {
        try {
            FileInputStream serviceAccount = new FileInputStream("/Library/Java/JavaVirtualMachines/javafx-sdk-17.0.8/blossom-40039-firebase-adminsdk-heiuo-f52f3c2390.json");
